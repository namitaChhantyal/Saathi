 ...
 <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="images/none.jpg" style="height: 650px; width: 1600px; margin-bottom: 10px;" alt="First slide">
                <div class="carousel-caption d-none d-md-block">
                  <p style="color: black;">WELCOME TO Saathi</p><a href="register.php" class="hvr-shutter-out-horizontal">Create your Profile</a>
              </div>
            </div>
        </div>
    </div>
