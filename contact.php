...
<div class="grid_3">
  <div class="container">
   ...
   <div class="grid_5">
      <p>Contact us if anything happened. Also you can contact us if you want any help from us and any suggestions for us. We 
      ...
      <address class="addr row">
       <!--  <dl class="grid_4">
        ...
        <dl class="grid_4">
            <dt>E-mail :</dt>
            <dd><a href="malito:mail@demolink.org">info@saathi.com</a></dd>
        </dl>
      </address>
    </div>
   </div>
